        ...
        {incomes.map((inc, i) => (
          ...
          >
            ...
            <input
              ...
              className="flex-[1.4] min-w-0 glass rounded-xl px-3 py-2.5 text-sm font-medium text-foreground placeholder:text-muted-foreground/40 outline-none focus:ring-2 focus:ring-green-400/30 transition-all"
            />
